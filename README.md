...
**[Правила для Vaultwarden](data/vaultwarden-equivalent-domains.txt)** · **[Read-only API](https://krotname.github.io/rf-credential-relationships/api/latest.json)** · **[Последний выпуск](https://github.com/krotname/rf-credential-relationships/releases/latest)**

## Данные

Снимок `v2.0.0` содержит 2 437 типизированных связей:
...
Готовый TXT содержит 54 группы (230 доменов) для Vaultwarden. В него попадают только взаимные DAL-связи сайтов; связи с приложениями и WebAuthn остаются отдельными типизированными записями.
